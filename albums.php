...
<div class="pager page-3">
  <div class="album-segment song-list">
    ...
    <div class="fg">
      <div class="wrapper vertical-centered">
        <div class="song-list-content vertical-content">
          ...
          <div class="song-player">
            ...
            <a class="button blue rounded" id="previewAllLink" href="#previewAll">Preview all</a>
            <a class="button blue rounded" id="buyAlbumLink" href="#buy" target="_blank">Buy this album</a>
          </div>
